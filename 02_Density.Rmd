...
write.csv(allocebus_dat,"~/Documents/GitHub/COMATSA_GitHub2/Data/allocebus_dat.csv")
...
#Get detection probability
microcebus_detection_prob <- predict(model6_microcebus)$fitted[[1]]
...
microcebus_dat <- microcebus_dat %>% dplyr::select(-Site, -Transect, -Type)
...
write.csv(microcebus_dat,"~/Documents/GitHub/COMATSA_GitHub2/Data/microcebus_dat.csv")
...
write.csv(cheirogaleus_dat,"~/Documents/GitHub/COMATSA_GitHub2/Data/cheirogaleus_dat.csv")
...
write.csv(lepilemur_dat,"~/Documents/GitHub/COMATSA_GitHub2/Data/lepilemur_dat.csv")
```
...
write.csv(avahi_dat,"~/Documents/GitHub/COMATSA_GitHub2/Data/avahi_dat.csv")
...
write.csv(rubriventer_dat,"~/Documents/GitHub/COMATSA_GitHub2/Data/rubriventer_dat.csv")
```
...
write.csv(albi_dat,"~/Documents/GitHub/COMATSA_GitHub2/Data/albi_dat.csv")
```
...
density_data <- prop_dat$Density_km2

# Mean and standard error of the data
mean_density <- mean(density_data, na.rm = TRUE)
se_density <- sd(density_data, na.rm = TRUE) / sqrt(length(density_data[!is.na(density_data)]))

# Calculate the 95% CI
alpha <- 0.05
z <- qnorm(1 - alpha / 2)  # Z-value for 95% CI
ci_lower <- mean_density - z * se_density
ci_upper <- mean_density + z * se_density

# Display the CI
cat("95% Confidence Interval: [", ci_lower, ", ", ci_upper, "]\n")

write.csv(prop_dat,"~/Documents/GitHub/COMATSA_GitHub2/Data/prop_dat.csv")
...
write.csv(hapa_dat,"~/Documents/GitHub/COMATSA_GitHub2/Data/hapa_dat.csv")
