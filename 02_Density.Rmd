...
gof_ds(model9_microcebus)
gof_ds(model10_microcebus)
gof_ds(model11_microcebus)

#Compare AIC calues
AIC(model1_microcebus, model2_microcebus, model3_microcebus, model4_microcebus, model5_microcebus, model6_microcebus, model8_microcebus, model9_microcebus)

#Plot the best-fitting model that also looks the most reasonable 
plot(model8_microcebus, nc=6)

#Get detection probability
microcebus_detection_prob <- predict(model8_microcebus)$fitted[[1]]
...
mean(na.omit(microcebus_dat$Density_km2))
